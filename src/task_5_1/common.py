...
def load_all_data():
    ...
    """
    # Load training data
    X_train = np.load(file="/home/morais/AAut_project/data/Xtrain1.npy")
    
    # Load training labels
    Y_train = np.load(file="/home/morais/AAut_project/data/Ytrain1.npy")
    
    # Load extra training data
    X_train_extra = np.load(file="/home/morais/AAut_project/data/Xtrain1_extra.npy")
    
    # Load test data
    X_test = np.load(file="/home/morais/AAut_project/data/Xtest1.npy")
